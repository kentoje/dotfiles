...
### 7. Write refactor RFC

Write the refactor proposal to a file using the RFC template in [REFERENCE.md](REFERENCE.md). Place it in `.agents/rfcs/` within the project. Share the file path with the user.
