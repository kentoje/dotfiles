...
source ~/dotfiles/.config/fish/includes/global.fish
source ~/dotfiles/.config/fish/includes/fzf.fish
source ~/dotfiles/.config/fish/includes/abbr.fish
source ~/dotfiles/.config/fish/includes/alias.fish
