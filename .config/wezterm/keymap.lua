...
function module.apply_to_config(config)
	...
	config.keys = {
		...
		-- Tmux session quickswitch indexed at 0 by default
		{ key = "1", mods = "CTRL", action = wezterm.action.SendString("\x01s1") },
		{ key = "2", mods = "CTRL", action = wezterm.action.SendString("\x01s2") },
		{ key = "3", mods = "CTRL", action = wezterm.action.SendString("\x01s3") },
		{ key = "4", mods = "CTRL", action = wezterm.action.SendString("\x01s4") },
		{ key = "5", mods = "CTRL", action = wezterm.action.SendString("\x01s5") },
		{ key = "6", mods = "CTRL", action = wezterm.action.SendString("\x01s6") },
		{ key = "7", mods = "CTRL", action = wezterm.action.SendString("\x01s7") },
		{ key = "8", mods = "CTRL", action = wezterm.action.SendString("\x01s8") },
		{ key = "9", mods = "CTRL", action = wezterm.action.SendString("\x01s9") },
		{ key = "0", mods = "CTRL", action = wezterm.action.SendString("\x01s0") },
